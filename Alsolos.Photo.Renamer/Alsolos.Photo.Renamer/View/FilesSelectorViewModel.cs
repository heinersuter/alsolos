namespace Alsolos.Photo.Renamer.View {
    ...
    public class FilesSelectorViewModel : ViewModel {
        private readonly FileSystemService _fileSystemService = new FileSystemService();

        public FilesSelectorViewModel(FileRenameViewModel fileRenameViewModel) {
        ...
        public int FilesCount {
            get { return AllFiles != null ? AllFiles.Count : 0; }
        }
